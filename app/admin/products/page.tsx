  ...
  return (
    <div>
      ...
      <p className="mt-4 max-w-2xl leading-8 text-zinc-500">
        Khu vực này sẽ được xây ở phase tiếp theo.
      </p>

      <div className="mt-10 rounded-[2rem] border border-dashed border-black/15 bg-white/70 p-10 text-center text-zinc-400">
        Coming soon.
      </div>
    </div>
  )
