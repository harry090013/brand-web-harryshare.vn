    ...
    <main className="bg-cream min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-4 py-20 border-t border-gray-200">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {cats.map((cat, i) => (
            <Link key={cat.slug} href={`/chia-se?category=${cat.slug}`} className="bg-white p-8 rounded-xl border border-gray-100 shadow-[0_2px_10px_-4px_rgba(0,0,0,0.05)] hover:shadow-md transition group flex flex-col">
              ...
              <div className="text-xs uppercase tracking-widest font-medium text-gray-400 group-hover:text-sage flex items-center gap-2 transition">
      ...
      <section className="max-w-5xl mx-auto px-4 pb-24">
        <div className="bg-cream-alt rounded-3xl p-12 md:p-20 text-center border border-gray-200/50">
          ...
          <form className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            ...
            />
            <button type="submit" className="bg-sage text-white px-8 py-3 text-sm font-medium rounded-md hover:bg-opacity-90 transition whitespace-nowrap">
              Đăng ký
            </button>
          </form>
